...
describe("validation", () => {
  ...
  test("rejects HTTP server definitions", () => {
    ...
    expect(
      v.serverDefinition({ command: "node", args: ["server.js"] }),
