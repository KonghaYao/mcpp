...
.crumbs { display:flex; flex-wrap:wrap; gap:8px; margin:0 0 14px; color:var(--muted); font-size:12px; }.crumbs a { text-decoration:none; }.crumbs a:hover { color:var(--cobalt); }.crumbs .sep { color:var(--m-rule-strong); }
